...
doc_path = r"D:\ollamaProject\BOI\BOI.pdf"
model = "llama3.2"
...
#a simple techique to generate multiple questions from a single question and retrieve documents
...
#res = chain.invoke(input=("What is th edocument about?",))
